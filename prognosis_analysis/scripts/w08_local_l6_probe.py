...
def build_audit(real_a, performance, correctness):
    ...
    return OrderedDict((
        ...
        ("test_evidence", {
            "targeted_command": "tools\\run_t2_radiomics.ps1 -PythonArguments @('-m','unittest','-q','tests.test_w08_formal_serial_contract','tests.test_w08_l5_parallel_checkpoint','tests.test_r6_5_validation','tests.test_w08_technical_preflight_a','tests.test_w08_local_optimization_probe','tests.test_w08_local_l6_probe')",
            "complete_regression_command": "tools\\run_t2_radiomics.ps1 -PythonArguments @('-m','unittest','discover','-s','tests','-p','test*.py','-q')",
            "targeted_tests_run": 46,
            "targeted_passed": 46,
            "targeted_failed": 0,
            "targeted_errors": 0,
            "complete_tests_run": 308,
            "complete_passed": 307,
            "complete_failed": 1,
            "complete_errors": 0,
